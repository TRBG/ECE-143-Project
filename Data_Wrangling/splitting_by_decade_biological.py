"""
This script  will read the cleaned biologicsl data (stored in the files: cleaned_biological_data_i.csv,
where i is a number from 2 to 16). The data stored in these files have been cleaned
in the script: data_cleaning_biological.py.
...
cleaned_biological_data_of_thedecade.csv, where decade is of the form 1950s, 1950s, ...
2010s.
...
def main():
    ...
    # The file indix as our files are ordered (check the data_cleaning_biological.py) from 2
    # to 16
    dataframe_ind = 2
    ...
    for i in range(len(decades)):
        ...
        start = time.time()
        fname =  'cleaned_biological_data_' + str(dataframe_ind) + '.csv'
        ...
        decades_data_fname = 'cleaned_biological_data_of_the' + str(decades[i][0]) + 's.csv'
